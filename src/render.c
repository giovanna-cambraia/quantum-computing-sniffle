...
void render_bloch_frame(Vector3 center) {
    DrawSphereWires(center, 1.0f, 16, 16, LIGHTGRAY);

    DrawLine3D(Vector3Add(center, (Vector3){-1.3f, 0, 0}), Vector3Add(center, (Vector3){1.3f, 0, 0}), GRAY);
    DrawLine3D(Vector3Add(center, (Vector3){0, -1.3f, 0}), Vector3Add(center, (Vector3){0, 1.3f, 0}), GRAY);
    DrawLine3D(Vector3Add(center, (Vector3){0, 0, -1.3f}), Vector3Add(center, (Vector3){0, 0, 1.3f}), GRAY);
}
